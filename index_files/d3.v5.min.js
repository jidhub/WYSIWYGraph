// https://d3js.org v7.9.0 Copyright 2010-2023 Mike Bostock // With a few changes by AG to allow delay between force simulation steps, marked as //AG
...
function simulation(nodes) {
  var simulation,
      ...
      forces = new Map(),
      stepDelay = 50,
      stepper = interval(step, stepDelay), //AG: original line was: stepper = timer(step),
  ...
  return simulation = {
    ...
    restart: function() {
      return stepper.stop(), (stepper = interval(step, stepDelay)), simulation;//AG: original line was:  return stepper.restart(step), simulation;
    },
    
    stepDelay: function(_) { //AG: these four lines are new
      return arguments.length ? (stepDelay = _, simulation) : stepDelay;
    },
